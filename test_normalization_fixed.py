...
def test_observation_normalization():
    ...
    # Load sample data
    df, _ = load_data()  # Returns (df, df_original)
...
def test_reward_scaling():
    ...
    # Allow for small floating-point errors in reward bounds
    assert all(-10.1 <= r <= 10.1 for r in all_rewards), "Rewards should be approximately in [-10, 10] range"
