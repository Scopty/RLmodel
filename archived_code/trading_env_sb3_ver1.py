...
class TradingEnv(Env):
    ...
    def step(self, action): 
        ...
        if self.debug: print(f"Step: {self.current_step}, Valid Actions: {valid_actions}, Action Mask: {action_mask}, Selected Action: {original_action}, Invalid Action: {str(original_action not in valid_actions)}")
        obs = self.get_obs()  # Use the updated observation method
